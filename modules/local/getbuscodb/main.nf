...
process GETBUSCODB {
    ...
    tuple val("${task.process}"), val('getbuscodb'), eval("getbuscodb --version"), topic: versions, emit: versions_getbuscodb
    ...
    # extract list of lineages of interest
    ...
    # run map_busco_db_to_sample.py
    # check if this is necessary because the mapping logic in nextflow might be easier to implement
    getbuscodb \\
        $args \\
        -@ $task.cpus \\
        -o ${prefix}.bam \\
